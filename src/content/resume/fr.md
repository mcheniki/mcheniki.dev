...
navigationLabel: 'Navigation dans le parcours'
navigation:
...
experiences:
    - period: 'Depuis oct. 2024'
      ...
      location: 'À distance'
      summary: 'Je conçois et maintiens des solutions web sur mesure, du cadrage technique à la livraison.'
      highlights:
          - 'Plugins WordPress, blocs Gutenberg et outils d’administration adaptés aux besoins métier.'
    ...
    - period: 'Oct. — déc. 2025'
      ...
      summary: 'J’ai transposé un design system existant en composants Gutenberg flexibles et réutilisables.'
      highlights:
          - 'Blocs sur mesure avec ACF Pro, PHP et React, pensés pour de multiples scénarios éditoriaux.'
    ...
    - period: 'Sept. 2022 — sept. 2024'
      ...
      summary: 'J’ai piloté la livraison technique de projets d’agence tout en restant directement impliqué dans le code.'
      highlights:
          - 'Choix d’architecture, standards de développement, revues de code et accompagnement technique.'
    ...
    - period: 'Mars 2019 — fév. 2022'
      ...
      summary: 'J’ai contribué à Télé-Loisirs et Programme TV, des produits médias à fort trafic.'
      highlights:
          - 'Refonte progressive du front-end avec coexistence des architectures historique et moderne.'
    ...
    - period: 'Juil. 2018 — janv. 2019'
      ...
      summary: 'J’ai réalisé des sites vitrines et événementiels WordPress avec des fonctionnalités pilotées par API.'
      highlights:
...
closingTitle: 'Envie d’échanger ?'
closingText: 'Parlons de votre projet ou de votre équipe.'
stackLabel: 'Stack'
progressLabel: 'Progression dans la page'
---
